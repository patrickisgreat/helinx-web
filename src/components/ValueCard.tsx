...
export default function ValueCard({ title, description, index }: ValueCardProps) {
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-8 hover:shadow-lg hover:border-primary-100 transition-all duration-300">
      <div className="w-14 h-14 rounded-lg bg-primary-50 text-primary-600 flex items-center justify-center mb-6">
        {icons[index] || icons[0]}
      </div>
